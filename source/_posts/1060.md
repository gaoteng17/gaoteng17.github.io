...
7. 复制shell到apache根目录下，开启apache服务：

{% asset_img 7.PNG %}

8. 网页SSI注入命令下载shell脚本：

{% asset_img 8.PNG %}

9. 修改shell脚本权限，增加可执行权限：

{% asset_img 9.PNG %}

10. 注入执行命令，msf获得反弹shell：

{% asset_img 10.PNG %}

11. 官方教程说本机没有设置flag，不过权限不够也访问不了`/root`，尝试提权无从下手，太菜了，以后再回来看看。
