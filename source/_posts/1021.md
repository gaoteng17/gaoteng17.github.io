...
[H3C-GigabitEthernet1/0/1]port-security maport-security port-mode autolearn //自动学习模式，必须先设置端口允许接入的最大MAC数量
...
[H3C-GigabitEthernet1/0/1]undo port-securiundo port-security max-mac-count
```
