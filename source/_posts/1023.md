...
|**操作**|**命令**|
|-|-|
|显示地址转换信息|<H3C>**display nat { address-group** *group-number* **/ all /outbound** *port-block-group* **/ server / statistics / session }**|
|调试地址转换过程|<H3C> **debugging nat { alg / config / event / packet** *acl number* **}**|
|清除地址转换连接|<H3C> **reset nat session**|
